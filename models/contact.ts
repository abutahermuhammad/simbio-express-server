...
import { CompleteAmbulance, RelatedAmbulanceSchema, CompleteBloodCenter, RelatedBloodCenterSchema, CompleteClub, RelatedClubSchema, CompleteCountry, RelatedCountrySchema, CompleteDonation, RelatedDonationSchema, CompleteHospital, RelatedHospitalSchema, CompletePerson, RelatedPersonSchema, CompleteVersion, RelatedVersionSchema } from "./index"
...
export interface CompleteContact extends z.infer<typeof ContactSchema> {
  ...
  Person_Person_contact_idToContact: CompletePerson[]
}
...
export const RelatedContactSchema: z.ZodSchema<CompleteContact> = z.lazy(() => ContactSchema.extend({
  ...
  Person_Person_contact_idToContact: RelatedPersonSchema.array(),
}))
