...
import { CompletePerson, RelatedPersonSchema, CompleteOrganization, RelatedOrganizationSchema, CompleteVersion, RelatedVersionSchema } from "./index"
...
export interface CompleteTeam extends z.infer<typeof TeamSchema> {
  Person_Person_teamIdToTeam: CompletePerson[]
...
export const RelatedTeamSchema: z.ZodSchema<CompleteTeam> = z.lazy(() => TeamSchema.extend({
  Person_Person_teamIdToTeam: RelatedPersonSchema.array(),
